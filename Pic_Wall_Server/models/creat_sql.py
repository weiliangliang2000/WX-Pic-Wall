from sqlalchemy import create_engine, DateTime, Column, Integer, String, Sequence, Date, insert, ForeignKey
from sqlalchemy.ext.declarative import declarative_base
from sqlalchemy.orm import sessionmaker
import datetime
from sqlalchemy.sql import func

engine = create_engine('mysql://root:123456@localhost/pic_wall', echo=True)
